    ...
    <>
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 16, marginBottom: 20 }}>
        <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #E5E5EA', padding: '20px 22px', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
          ...
          <div style={{ fontSize: 11, color: '#57575A', marginBottom: 12 }}>component issues per site across scans</div>
        ...
        <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #E5E5EA', padding: '20px 22px', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
          ...
          <div style={{ fontSize: 11, color: '#57575A', marginBottom: 12 }}>Active component issues grouped by tier</div>
