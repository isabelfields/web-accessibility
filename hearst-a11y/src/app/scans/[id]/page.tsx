...
import { countIssueTypes, countOccurrences, formatSignedDelta, getSeverityCounts, isActiveWcagPattern, isWcagPattern, pluralize } from '@/lib/metrics'
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-8">
            ...
            <div className="rounded-lg bg-white border border-[#E5E5EA] p-6 flex flex-col justify-between">
              <div className="text-[11px] font-semibold text-[#3A3A3C] uppercase tracking-wider mb-3">Component Issues</div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-[#F5F5F7] border-b border-[#E5E5EA]">
                      ...
                      <th className="text-right px-4 py-3 text-[11px] font-semibold text-[#3A3A3C] uppercase tracking-wider">Component Issues</th>
