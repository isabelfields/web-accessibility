...
7. Users can enter their own Jira project key in the violation card when creating
   a ticket, so different users/teams can route issues to different Jira projects.
